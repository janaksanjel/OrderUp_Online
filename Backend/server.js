...
import ratingRouter from './routs/ratingRoute.js';

import SubAdminrouter from './routs/SubAdmin.js';
import SuperAdminRouter from './routs/SuperAdmin.js';
...
// Root endpoint all design is here srever running page
app.get('/', (req, res) => {
...
#strobe_color3 {
  ...
  animation-delay: 3s;
        ...
        <body>
            ...
            <div class="container">
            <h1>Welcome to Our Server API!</h1>
  ...
  <div class="Ghost">
    ...
    >
      ...
      ></path>
            ...
            <h3>We used mongodb for Database</h3>
                <h4>API Working!</h4>


              
                <p>Your API is up and running smoothly. Feel free to explore and integrate!</p>
            </div>
            <footer>
                <p>&copy; 2024 OrderUP. All rights reserved.</p>
                <p>Developed by Janak Sanjel</p>
            </footer>
        </body>
        </html>
    `);
